...
p=function(a){var c=b.fuzzyMatches(a);c.forEach(function(a,e){var f=b.indexOf(a.text);c[e]=r(f,d);c[e].txt="";c[e].priority=a.priority;a.text.split("").forEach(function(b,d){-1!==a.matches.indexOf(d)?c[e].txt+="<strong>"+b+"</strong>":c[e].txt+=b})});return c};q=function(a){if(a.trim().length){var c=a.split(" ")[0].toLowerCase();a=a.replace(c,"").trim();var b=!1,e;for(e in h)if(h.hasOwnProperty(e)){var d=h[e];if(b)return;0===d.command.indexOf(c)&&(d.dynamicLink=a.length?d.url+d.start+d.param+"="+
encodeURIComponent(a):d.url,b=d)}return b}}});b(document).ready(function(){var d=document.createElement("div");b(d).addClass("rocketbar-wrapper");b(d).append('<input type="text" id="rocketbar" placeholder="Type to navigate..." autofocus="yes" value="" /><ul id="rocketbar-list"></ul>');b("body").append(d);var l=b("#rocketbar"),h=b("#rocketbar-list"),e=0;b(document).on("keyup",function(b){if(!g())return e=0;b.preventDefault();38===b.keyCode?e--:40===b.keyCode&&e++;0>e&&(e=0);k()});l.on("keyup",function(c){13===
c.keyCode&&(c.preventDefault(),b("#rocketbar-list > li > a").each(function(a,c){a===e&&(b(c).click(),document.location=b(c).attr("href"))}))});l.on("change keyup keydown paste",function(){h.html("");var c=q(b(this).val());c&&h.append("<li>"+c.iconHTML+'<a href="'+c.dynamicLink+'">'+c.description+"</a></li>");c=p(b(this).val());c=c.slice(0,10);c.forEach(function(a){h.append("<li>"+a.iconHTML+'<a href="'+a.link+'">'+a.txt+"</a></li>")});k()});b(document).on("keydown",function(c){c.shiftKey&&32===c.keyCode&&
b(d).toggle();27===c.keyCode&&g()&&b(d).hide();g()||l.val("");" "===l.val()&&l.val("");l.focus()});var k=function(){h.find("li").each(function(c,a){c===e?b(a).addClass("selected"):b(a).removeClass("selected")})},g=function(){return b(d).is(":visible")}})})(jQuery);
